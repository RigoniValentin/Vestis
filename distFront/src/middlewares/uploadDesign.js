...
exports.handleDesignUploadError = exports.deleteDesignImage = exports.compressAndSaveDesignImage = exports.uploadDesignImage = void 0;
...
const fileFilter = (req, file, cb) => {
    console.log(`🔍 Validando archivo Design: ${file.originalname}, tipo: ${file.mimetype}`);
...
exports.uploadDesignImage = (0, multer_1.default)({
    storage,
    fileFilter,
    limits: {
...
const compressAndSaveDesignImage = async (req, res, next) => {
    try {
        ...
        const uploadDir = path_1.default.join(process.cwd(), "uploads", "designs");
...
exports.compressAndSaveDesignImage = compressAndSaveDesignImage;
// Función para eliminar imagen de Design
const deleteDesignImage = async (imagePath) => {
    try {
        if (!imagePath)
            return false;
...
exports.deleteDesignImage = deleteDesignImage;
// Middleware de manejo de errores
const handleDesignUploadError = (error, req, res, next) => {
...
exports.handleDesignUploadError = handleDesignUploadError;
exports.default = {
    uploadDesignImage: exports.uploadDesignImage,
    compressAndSaveDesignImage: exports.compressAndSaveDesignImage,
    deleteDesignImage: exports.deleteDesignImage,
    handleDesignUploadError: exports.handleDesignUploadError,
    MAX_FILE_SIZE,
    ALLOWED_MIME_TYPES,
};
